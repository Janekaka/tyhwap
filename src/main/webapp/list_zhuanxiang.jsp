...
<body>
	...
	<div id="banner_button">
		<div id="banner_top" style="width:100%;text-align:center;padding-top:15px;margin-bottom:20px;">
			<button style="width:28%;">学生票务</button>
			<button style="width:28%;">旅游路线</button>
			<button style="width:28%;">特色活动</button>
		</div>
	...
	<!-- 列表项 -->
	<div id="list_container" style="width:95%;margin: 0 auto;">
